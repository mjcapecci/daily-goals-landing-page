  ...
  return (
    <Layout>
      ...
      <div className="policy">
        ...
        <br></br>
        <p>
          Thank you for choosing to be part of our community at Michael Capecci
        ...
        <h2>3. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
        <p>
        ...
        <p>
          ...
          at mjcapecci@gmail.com or by post to:
        </p>
        <p>
          Michael Capecci
          <br></br>
